...
Particle::Particle(std::array<double, 3> x_arg, std::array<double, 3> v_arg,
                   double m_arg, double gGrav_arg, int type_arg) : x(x_arg), v(v_arg), m(m_arg), gGrav(gGrav_arg),
                   type(type_arg) {
    f = {0., 0., 0.};
    old_f = {0., 0., 0.};
    // spdlog::debug("Particle generated!");
...
Particle::Particle(std::array<double, 3> x_arg, std::array<double, 3> v_arg, std::array<double, 3> f_arg,
                   std::array<double, 3> oldf_arg,
                   double m_arg, double gGrav_arg, int type_arg) : x(x_arg), v(v_arg), f(f_arg), old_f(oldf_arg),
                                                                   m(m_arg), gGrav(gGrav_arg),  type(type_arg) {
}
...
double Particle::setGGrav(const double &nGGrav) {
    gGrav = nGGrav;
}
